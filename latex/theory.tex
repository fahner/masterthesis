...
Leptons do not carry colour charge as opposed to quarks.
...
With the transition from a \bquark to a \cquark quark by the emission of a \Wm boson, the \Lb can decay into a \Lc baryon.
...
Currently, there is a large interest in the measurement of $|\Vub|$ since it is the least known among the CKM matrix element and there is a deviation of about $3\sigma$ between measurements of $|\Vub|$ using either exclusive, \decay{\B}{\pi\ell\neul}, or inclusive, \decay{\B}{X_u\ell\neul}, semileptonic decays.
...
If one misses the proton and randomly adds a pion to the \Dz meson to form a \Dstar candidate, it mimics a \decay{\Bz}{\Dstarm\mup\neum X} decay.
